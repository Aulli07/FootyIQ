...
export function PostDisplay({ post }: { post: PostType }) {
  return (
    <Link href={{pathname: "/view-particular-talk", query: {postId: post.id}}}>
      <div className="flex justify-start items-start gap-4 w-full relative p-5 border border-white/20 rounded-lg bg-white/4 shadow-lg backdrop-blur">
        <div>
